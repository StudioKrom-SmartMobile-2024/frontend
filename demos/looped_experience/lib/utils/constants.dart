...
const DIFFICULTY_ROUTE = "/difficulty/:experienceName";
const DIFFICULTY_MALL_ROUTE = "/difficulty/mall";
const DIFFICULTY_STATION_ROUTE = "/difficulty/station";
const DIFFICULTY_CONCERT_ROUTE = "/difficulty/concert";
const DIFFICULTY_PLAYGROUND_ROUTE = "/difficulty/playground";
